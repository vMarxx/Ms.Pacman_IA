...
public class Replay
{
    ...
    public ControlPacMan getPacMan()
    {
        return pacMan;
    }

    public ControlFantasmas getGhosts()
    {
        return ghosts;
    }
    ...
    class ReplayMsPacman implements ControlPacMan
    {
	...
	//Simple controller that simply plays the next recorded action
    class ReplayGhostTeam implements ControlFantasmas
    {

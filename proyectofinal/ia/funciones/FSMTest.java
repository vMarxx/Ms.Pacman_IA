...
public class FSMTest {
	...
	static class MyCondition extends Condicion {
	...
	static class MyAction extends Accion {
	...
	static class MyTransition extends Transicion {
	...
	static class MyState extends EstadoMaquinaEstado {
		public String entryText;
		public String exitText;
		public String text;
		
		@Override 
		public Accion getEntryActions() {
	...
	public static void main(String[] args) {
		...
		EstadoMaquina sm = new EstadoMaquina();
	...
	public static void act(Accion actions) {
		while (actions != null) {
			actions.act();
